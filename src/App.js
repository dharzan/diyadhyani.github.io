    ...
    <div style={{ position: 'absolute', top: 20, right: 20 }}>
      ...
      {isOpen && (
        ...
        <a href="/" style={itemStyle} onMouseOver={(e) => e.currentTarget.style.backgroundColor = '#f2f2f2'} onMouseOut={(e) => e.currentTarget.style.backgroundColor = 'white'}>Home</a>
          ...
          <a href="/AboutMe" style={itemStyle} onMouseOver={(e) => e.currentTarget.style.backgroundColor = '#f2f2f2'} onMouseOut={(e) => e.currentTarget.style.backgroundColor = 'white'}>About Me</a>
