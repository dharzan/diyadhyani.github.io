...
function IntroSection() {
    return (
      <>
        <h1 style={styles.heading}><FaBrain style={styles.icon} />Hello, I'm Diya Dhyani</h1>
  ...
  function AcademicSection() {
    return (
      <div>
        <h2 style={styles.heading} paddingLeft={'20'}><FaUniversity style={styles.icon} />Academic Background & Skills</h2>
        {/* <p style={styles.paragraph}>
